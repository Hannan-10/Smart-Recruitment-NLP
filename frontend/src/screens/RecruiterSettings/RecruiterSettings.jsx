...
import './ApplicantSettings.css' // Using the same CSS for consistency

const settingsOptions = [
  {
    key: 'edit-profile',
    title: 'Edit profile',
    description: 'Update company, experience, skills, and name from one place.',
      ...
      return (
        <div className="settings-form">
          ...
          <label className="settings-field">
            <span className="field-label"><FiBriefcase /> Company</span>
            <input
              name="company"
          ...
          <label className="settings-field">
            <span className="field-label"><FiStar /> Hiring Expertise (Skills)</span>
            <div className="skills-container">
              ...
              <input
                ...
                placeholder="Add a skill/expertise..."
              />
            </div>
          </label>
        </div>
        ...
        <section className="settings-main">
          <div className="settings-panel">
            <div className="panel-header">
              <span className="panel-label">Account Settings</span>
              <h2>{activeOption?.title}</h2>
              <p className="panel-copy">{activeOption?.description}</p>
            </div>
            ...
            <div className="panel-footer">
              <button
                ...
                className={`panel-action-btn ${activeOption?.key === 'delete-account' ? 'danger' : ''}`}
              >
